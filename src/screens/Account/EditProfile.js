...
class EditProfile extends Component {
  ...
  searchCountry = s => {
    ...
    // this.setState({
    //   enteredCountry: s,
    //   //countryData: searchedCountry,
    // });
    // let searchedCountry = countryData.filter(item => {
    ...
    this.setState({clonecountryData: filteredData});
  };
...
export default connect(
  mapStateToProps,
  {getProfile, allParameters, getStateList, getCityList, updateUserProfile},
)(EditProfile);
